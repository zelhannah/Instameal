...
public final class ActivityNavigationBinding implements ViewBinding {
  ...
  private ActivityNavigationBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull FrameLayout frameLayout, @NonNull ConstraintLayout main,
      @NonNull Switch switchDarkMode, @NonNull Toolbar toolBar) {
  ...
  public static ActivityNavigationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNavigationBinding((ConstraintLayout) rootView, appBar,
          bottomNavigationView, frameLayout, main, switchDarkMode, toolBar);
    }
